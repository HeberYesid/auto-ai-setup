...
export class FileSystemManagedStateStore extends FileSystemSkillOwnershipStore {
  public constructor(fileSystem: FileSystemPort) { super(fileSystem); }
}

export const createFileSystemManagedStateStore = (fileSystem: FileSystemPort): FileSystemManagedStateStore => new FileSystemManagedStateStore(fileSystem);
